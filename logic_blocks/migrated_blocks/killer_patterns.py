"""
killer_patterns - мигрированный блок из JSON.
"""
...
class KillerPatternsBlock(KnowledgeBlock):
    """Блок знаний из killer_patterns.json"""
    
    def __init__(self):
        super().__init__(
            name="killer_patterns",
            description="Блок знаний из killer_patterns.json",
            weight=1.0,
            category="patterns"
        )
    ...
    def get_config_summary(self) -> Dict[str, Any]:
        return {
            ...
            "source_file": "killer_patterns.json"
        }


def register_block():
    return KillerPatternsBlock()
