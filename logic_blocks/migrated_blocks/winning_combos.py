"""
winning_combos - мигрированный блок из JSON.
"""
...
class WinningCombosBlock(KnowledgeBlock):
    """Блок знаний из winning_combos.json"""
    
    def __init__(self):
        super().__init__(
            name="winning_combos",
            description="Блок знаний из winning_combos.json",
            weight=1.0,
            category="patterns"
        )
    ...
    def get_config_summary(self) -> Dict[str, Any]:
        return {
            ...
            "source_file": "winning_combos.json"
        }


def register_block():
    return WinningCombosBlock()
