"""
model_weights - мигрированный блок из JSON.
"""
...
class ModelWeightsBlock(KnowledgeBlock):
    """Блок знаний из model_weights.json"""
    
    def __init__(self):
        super().__init__(
            name="model_weights",
            description="Блок знаний из model_weights.json",
            weight=1.0,
            category="learning"
        )
  ...
  "ai_accuracy": {
    ...
    def get_config_summary(self) -> Dict[str, Any]:
        return {
            ...
            "source_file": "model_weights.json"
        }


def register_block():
    return ModelWeightsBlock()
