"""
Обновление get_bot_actions для ACTION PLAN
"""
...
print("✅ ACTION PLAN обновлен!")
print("Перезапусти сервер: Ctrl+C, затем python3 -m uvicorn backend.main:app --port 8001")
