...
filepath = "/Users/andreylp/affiliate_brain/app/frontend/bot-top5.html"
...
"""
    ...
    content = re.sub(r"document\.addEventListener\('DOMContentLoaded',\s*\(\)\s*=>\s*\{[^}]+\}\);", js_addition.strip(), content)
...
"""
    # Insert before document.getElementById('top5Cards').innerHTML
    content = content.replace("document.getElementById('top5Cards').innerHTML += `", render_addition + "\n            document.getElementById('top5Cards').innerHTML += `")
